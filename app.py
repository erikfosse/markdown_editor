...
from PyQt5.QtGui import QDesktopServices, QColor, QPainter, QTextFormat
...
class MarkdownEditor(QMainWindow):
    def __init__(self):
        ...
        self.preview.setStyleSheet("background: #111827; border: none; padding: 0 0 0 0;")
    ...
    def open_link(self, url: QUrl):
        ...
        if sys.platform.startswith("linux") and Path("/mnt/c/Windows/explorer.exe").exists():
        ...
        if sys.platform.startswith("linux") and Path("/mnt/c/Windows/system32/cmd.exe").exists():
            subprocess.Popen(["/mnt/c/Windows/system32/cmd.exe", "/c", "start", "", url.toString()])
